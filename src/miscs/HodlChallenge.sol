...
contract HodlChallenge {
    ...
    IERC20 public constant SNX = ProxyERC20(0xC011a73ee8576Fb46F5E1c5751cA3B9Fe0af2a6F);
    ...
    function isSolved() public view returns (bool) {
        ...
        return SNX.balanceOf(address(vault)) == 0 && block.timestamp <= vault.unlocktimestamp();
    }
}
